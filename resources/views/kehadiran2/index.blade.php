            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <!-- Year Filter Form -->
                        <form action="{{ route('kehadiran2.index') }}" method="GET" class="d-flex align-items-center me-1">
                            <input type="hidden" name="per_page" value="{{ $perPage }}">
                            <label for="year" class="me-1">Tahun:</label>
                            <select class="form-control form-control-sm me-2" id="year" name="year" onchange="this.form.submit()">
                                <option value="" selected>Pilih Tahun</option>
                        ...
                        <form method="GET" action="{{ route('kehadiran2.index') }}" class="d-flex align-items-center">
                            <input type="hidden" name="per_page" value="{{ $perPage }}">
