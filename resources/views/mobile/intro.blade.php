        ...
        <div class="align-items-center d-flex justify-content-center vh-100">
            <div>
                <div class="logo-area text-center">
                    <img class="light-logo" src="{{ asset('image/mobile/logo1_rm.png') }}" alt="img" style="width: 50%; height:auto;">
                    <img class="darkmode-logo" src="{{ asset('image/mobile/logo1_rm.png') }}" alt="img" style="width: 50%; height:auto;">
                </div>
                <h3>E-SIAGA</h3>
