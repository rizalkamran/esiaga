                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="d-flex align-items-center">
                            ...
                            <!-- Year Filter Form -->
                            <form action="{{ route('registrasi2.index') }}" method="GET" class="d-flex align-items-center ms-2 me-1">
                            ...
                            <form action="{{ route('regis2.export-pdf') }}" method="get" target="_blank" class="d-flex align-items-center mx-2">
                                <label for="acara" class="me-1" style="min-width: 125px;">Nama Kejuaraan:</label> <!-- Label for Acara -->
                                <select class="form-control form-control-sm me-2" id="acara" name="acara">
                    ...
                    <div class="col-md-12">
                        <div class="d-flex align-items-center">
                            ...
                            <form action="{{ route('registrasi2.index') }}" method="GET" class="d-flex align-items-center mx-2">
                                <label for="acara" class="me-1" style="min-width: 125px;">Nama Kejuaraan:</label>
