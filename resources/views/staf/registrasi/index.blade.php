                ...
                <table class="table table-sm table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#Modal1{{$ag->id}}">
                                    Foto
                                </button>
                                <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#Modal2{{$ag->id}}">
                                    KTP
                                </button>
                                <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#Modal3{{$ag->id}}">
                                    NPWP
                                </button>
                            </td>
                            <td>
